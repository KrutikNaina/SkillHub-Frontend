...
const About = () => {
  ...
  const handleExploreSkills = () => {
    navigate('/login') // ✅ Redirect to skills page
  }

  return (
    <section className="w-full min-h-screen py-20 bg-[#f4f6fa] dark:bg-gray-900 px-4 sm:px-6 lg:px-20 flex items-center justify-center">
